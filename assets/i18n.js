...
(function () {
  var DICTIONARY = {
    ...
    'prices.seeAllInApp': { es: 'Ver el top 20 completo, con búsqueda por consola, en la app', en: 'See the full top 20, with search by console, in the app', fr: 'Voir le top 20 complet, avec recherche par console, dans l\'application', it: 'Vedi la top 20 completa, con ricerca per console, nell\'app' },
